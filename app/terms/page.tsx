...
export default function TermsPage() {
  return (
    <LegalPage
      title="Terms of Service" subtitle="Legal" updated="March 20, 2026"
      ...
      sections={[
        ...
        { title: 'Account Data and Email Communications', content: ['By creating an account, you provide your email address which is used to operate your account, deliver transactional messages (account confirmation, payment receipts, renewal reminders), and send a short onboarding email sequence.', 'Your email address and aggregate usage statistics (sanitize counts, page counts, plan status) are accessible to Specterfy\'s administrator for service operations and support.', 'No document content you process is ever transmitted to or accessible by Specterfy or its administrators.', 'You may request deletion of your account and associated data at any time by contacting support.'] },
